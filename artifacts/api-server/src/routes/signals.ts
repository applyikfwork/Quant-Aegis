...
router.get("/signals", async (req, res): Promise<void> => {
  ...
  res.json(data.map(s => ({
    ...
    direction: s.signal_type === "buy" ? "LONG" : "SHORT",
    status: s.status,
    ...
    agentVotes: {},
    evidence: [s.reason ?? "AI-generated signal"],
    marketSnapshot: {},
    confidenceBreakdown: [],
    lifecycle: [{ event: "generated", ts: s.created_at, detail: "Signal generated by AI" }],
    pnl: null,
    reason: s.reason,
    atr: 0,
    volatilityRegime: "Normal",
    invalidationCondition: "Market structure break",
  })));
});
